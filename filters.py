...
async def passes_all_filters(pair, timeframe_cfg, min_volume_usd, exchange, is_AB, alltime=None, lst_all=None, colour=None, power = None, ema_timfraim=None, i=1):
    """
    ...
    if is_AB == True:
        ...
        #     return False
            ...
            if i == 1:
                pair2 = pair.split(':')[0]
                await passes_all_filters(pair2, timeframe_cfg, min_volume_usd, exchange, is_AB, alltime, lst_all, colour, power, 2)
